                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions-row">
                                            <a class="action-link" href="modifica_utente.php?id=<?php echo $row['id']; ?>">Modifica</a>
                                            <a class="action-link secondary" href="lista_utenti.php?elimina=<?php echo $row['id']; ?>">Elimina</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
